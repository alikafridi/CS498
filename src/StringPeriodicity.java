...
public class StringPeriodicity {
	...
	public static void analyzeDirections(String input_file_name, String output_file_name) {
		...
		StringPeriodicityHelpers helper = new StringPeriodicityHelpers();
		...
		try {
			...
			for (int i = 1; i < rows; i++) {
				...
				if (i == 1) {
					...
					directionList += StringPeriodicityHelpers.calculateDirection(delta_x, delta_y);
				}
			}
